...
func TestMemoryClient_TrackOperation(t *testing.T) {
	...
	operation := bucket.NewMetricOperation([3]string{"01", "02", "o3"}, []string{})
	success := true
...
func TestMemoryClient_TrackState(t *testing.T) {
	...
	section := "test-section"
	operation1 := bucket.NewMetricOperation([3]string{"01", "02", "o3"}, []string{})
	operation2 := bucket.NewMetricOperation([3]string{"p1", "p2", "p3"}, []string{})
	state1 := 13
	state2 := 66
	state12 := 77
