...
func TestMemory_IncrementAll(t *testing.T) {
	i := NewMemory()
	b1 := bucket.NewPlain("section1", bucket.NewMetricOperation("o11", "o12", "o13"), true, true)
	b2 := bucket.NewPlain("section2", bucket.NewMetricOperation("o21", "o22", "o23"), false, true)
	metricN := 5
